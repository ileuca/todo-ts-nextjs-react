        ...
        {tasks?.map((task)=>(
            <HStack key={task.id}>
                    ...
                    <Checkbox size='lg' colorScheme={handleColor(task.isDone)} isChecked={task.isDone} onChange={()=> handleChange(task.id)}>
                        <Button style={{maxWidth:"34vw",minHeight:"2.5rem",height:"auto", overflow:"hidden", whiteSpace:"break-spaces", textOverflow:"ellipsis",display:"inline-block", textAlign:"center"}} 
